...
<body>
	<div id="wrap">
		...
		<div class="header">
			<div class="logo">
				<a href="${base }/book/IndexAction"><img src="${base }/images/logo.gif" alt=""
					title="" border="0" /></a>
			</div>
			<div id="menu">
				<ul>
			...
			<div class="left_content">
				...
				<div>
					<div class="feat_prod_box">
						...
						<div class="prod_img">
							<a href="${base }/book/detailBook?bookId=${bestbook.bookId}"><img src="${base }/images/prod${status.count }.gif" alt=""
								title="" border="0" /></a>
						</div>
						...
						<div class="prod_det_box">
							...
							<div class="box_center">
								...
								<a href="${base }/book/detailBook?bookId=${bestbook.bookId}" class="more">- 更多信息 -</a>
								<div class="clear"></div>
				...
				<div class="new_products">
					...
					<div class="new_prod_box">
						<a href="${base }/book/detailBook?bookId=${newbook.bookId}">${newbook.bookName }</a>
						<div class="new_prod_bg">
							<span class="new_icon"><img src="${base }/images/new_icon.gif"
								alt="" title="" /></span> <a href="${base }/book/detailBook?bookId=${newbook.bookId}"><img
