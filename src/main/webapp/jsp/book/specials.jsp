			...
			<div class="left_content">
				...
				<div class="feat_prod_box">
					...
					<c:forEach items="${pageing.books }" var="book" varStatus="status">
						<div class="prod_img">
							<a href="${base }/book/detailBook?bookId=${book.bookId}"><img src="${base }/images/prod1.gif"
				...
				<div class="pagination">
						<c:if test="${pageing.pageNow!=1 }">
							<a href="${base }/book/viewBookByCate?pageNow=1&pageSize=${pageing.pageSize}">首页</a>&nbsp;
							<a href="${base }/book/viewBookByCate?pageNow=${pageing.pageNow-1 }&pageSize=${pageing.pageSize}">&lt;&lt;</a>&nbsp;
						</c:if>
						<c:choose>
						...
						<c:forEach var="p" begin="${beg }" end="${beg+2 }">
							<c:if test="${p<=pageing.pageCount }">
								<a href="/book/viewBookByCate?pageNow=${p}&pageSize=${pageing.pageSize}">${p }</a>
							</c:if>
						</c:forEach>
						<c:if test="${pageing.pageNow!=pageing.pageCount }">
							<a href="/book/viewBookByCate?pageNow=${pageing.pageNow+1}&pageSize=${pageing.pageSize}">&gt;&gt;</a>&nbsp;
							<a href="/book/viewBookByCate?pageNow=${pageing.pageCount}&pageSize=${pageing.pageSize}">末页</a>&nbsp;
						</c:if>
