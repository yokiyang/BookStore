	...
	<div id="wrap">
				...
				<div class="new_products">
					<c:forEach items="${pageing.books }" var="book" varStatus="status">
						<div class="new_prod_box">
							...
							<div class="new_prod_bg">
								...
								<a href="${base }/book/detailBook?bookId=${book.bookId}"><img
					...
					<div class="pagination">
						<c:if test="${pageing.pageNow!=1 }">
							<a
								href="${base }/book/cateBook?pageNow=1&pageSize=${pageing.pageSize}">首页</a>&nbsp;
							<a
								href="${base }/book/cateBook?pageNow=${pageing.pageNow-1 }&pageSize=${pageing.pageSize}">&lt;&lt;</a>&nbsp;
						</c:if>
						<c:choose>
						...
						<c:forEach var="p" begin="${beg }" end="${beg+2 }">
							<c:if test="${p<=pageing.pageCount }">
								<a
									href="${base }/book/cateBook?pageNow=${p}&pageSize=${pageing.pageSize}">${p
									}</a>
							</c:if>
						</c:forEach>
						<c:if test="${pageing.pageNow!=pageing.pageCount }">
							<a
								href="${base }/book/cateBook?pageNow=${pageing.pageNow+1}&pageSize=${pageing.pageSize}">&gt;&gt;</a>&nbsp;
							<a
								href="${base }/book/cateBook?pageNow=${pageing.pageCount}&pageSize=${pageing.pageSize}">末页</a>&nbsp;
						</c:if>
		...
		<div class="footer">
			...
			<div class="right_footer">
				<a href="${base }/book/IndexAction">home</a> <a
